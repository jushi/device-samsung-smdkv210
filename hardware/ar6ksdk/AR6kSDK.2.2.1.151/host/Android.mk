...
ifeq ($(TARGET_PRODUCT),$(filter $(TARGET_PRODUCT),qsd8250_surf qsd8250_ffa msm7630_surf smdkc100 smdkv210))
...
ATH_ANDROID_BUILD_FLAGS += -fno-pic
...
$(mod_cleanup) :
	...
	mkdir -p $(TARGET_OUT_UNSTRIPPED)/system/lib/modules
...
$(mod_file) : $(mod_cleanup) $(TARGET_PREBUILT_KERNEL) $(ACP)
	...
	$(ACP) $(ATH_TARGET_OUTPUT)/$(ATH_ANDROID_SRC_BASE)/host/os/linux/ar6000.ko $(TARGET_OUT_UNSTRIPPED)/system/lib/modules
